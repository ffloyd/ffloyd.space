...
When you do this, your `AGENTS.md` should contain only AI-specific adjustments like output format preferences or tool usage patterns. Everything about _understanding your code_ should already be documented for humans.
