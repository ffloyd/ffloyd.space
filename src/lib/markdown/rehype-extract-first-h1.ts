 ...
 *
 * Responsible for extracting title from the first h1 element.
 * Expects frontmatter to be already parsed (via remarkParseFrontmatter).
 * Sets `file.data.title` to the extracted title text, or leaves it undefined if no h1 exists.
 */
